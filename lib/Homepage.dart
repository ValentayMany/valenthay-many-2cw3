...
class _homepageState extends State<homepage> {
  ...
  Row _buildJournalFooterImages() {
    return Row(
      ...
      children: <Widget>[
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/3198.jpg'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/4293.jpg'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/6424.jpg'),
          radius: 40.0,
        ),
        SizedBox(
          width: 100.0,
